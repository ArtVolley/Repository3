...
namespace TestEx2.Module
{
    ...
    public partial class Generate : WindowController
    {
        ...
        {
            string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Password=;User ID=Admin;Data Source=Solution14.mdb;Mode=Share Deny None;"; //MSSqlConnectionProvider.GetConnectionString("ART-LAPTOP\\SQLEXPRESS", "TestEx2");
